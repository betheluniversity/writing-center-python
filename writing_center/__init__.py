...
from writing_center.proxy import ReverseProxied
...
# Allow app to work behind a reverse proxy
if app.config.get('PROXY_PATH'):
    app.wsgi_app = ReverseProxied(app.wsgi_app, script_name=app.config.get('PROXY_PATH'))
