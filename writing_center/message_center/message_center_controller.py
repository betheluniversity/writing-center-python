...
class MessageCenterController:
    ...
    def close_session_student(self, appointment_id):  # this needs to be called somewhere
    ...
    def close_session_tutor(self, appointment_id, to_prof):  # this needs to be called somewhere
        appointment = self.get_appointment_info(appointment_id)
        student = self.get_user_by_id(appointment.student_id)
